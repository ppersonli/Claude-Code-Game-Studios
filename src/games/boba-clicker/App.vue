...
<template><div ref="gameContainer" class="clicker-container"></div></template>
<style scoped>.clicker-container { width: 100%; height: 100dvh; overflow: hidden; background: #1a0a2e; }</style>

...
<template><div ref="gameContainer" class="runner-container"></div></template>
<style scoped>.runner-container { width: 100%; height: 100dvh; overflow: hidden; background: #1a0a2e; }</style>

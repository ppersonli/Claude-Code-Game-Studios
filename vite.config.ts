  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'cafe-tycoon': resolve(__dirname, 'src/games/cafe-tycoon/index.html'),
        'axolotl-clicker': resolve(__dirname, 'src/games/axolotl-clicker/index.html'),
        'gravity-merge': resolve(__dirname, 'src/games/gravity-merge/index.html'),
        'magnet-master': resolve(__dirname, 'src/games/magnet-master/index.html'),
        'synth-kitchen': resolve(__dirname, 'src/games/synth-kitchen/index.html'),
        'runway-fashion': resolve(__dirname, 'src/games/runway-fashion/index.html'),
      },
    },
  },
  server: {
